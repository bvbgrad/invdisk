...
public class OffersDao {
	...
	public boolean update(Offer offer) {
		...
		return jdbc.update("update offers set username=:username, text=:text"
	...
	public boolean create(Offer offer) {
		...
		return jdbc.update("insert into offers (username, text) "
	...
	public int[] create(List<Offer> offers) {
		...
		return jdbc.batchUpdate("insert into offers (id, username, text) "
				+ "values (:id, :username, :text)", params);
	}
